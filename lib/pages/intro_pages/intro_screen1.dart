    ...
    return Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [Color(0xffe9defa), Color(0xfffbfcdb), Color(0xfff3e7e9), Color(0xffe3eeff)]
        )
      ),
      child: SafeArea(
        child: ListView(
              ...
              child: SingleChildScrollView(
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Lottie.asset("assets/animations/intro_app_animations/hello.json", animate: true, width: 100),

                      Lottie.asset("assets/animations/intro_app_animations/welcome_text.json", animate: true, width: 225),
                    ],
                  ),
                ),
              ),
