...
import 'package:v_safe/src/pages/required_pages/incoming_fake_call.dart';
import 'package:v_safe/src/utils/constants.dart';
import 'package:v_safe/src/widgets/drawer_widgets/screen_drawer.dart';
                            ...
                            Column(
                              children: [
                                Padding(
                                  ...
                                  child: Text(fakeCallContactName, style: const TextStyle(fontSize: 24, color: Colors.black),),
                                ),
                                Padding(
                                  padding: const EdgeInsets.all(2.5),
